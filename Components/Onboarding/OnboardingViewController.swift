    ...
    */
    fileprivate func presentOnboarding() {
        ...
        **************************************************************/
        ...
        //let loginVerificationStep = LoginCustomWaitStep(identifier: LoginCustomWaitStep.identifier) //***COMMENTED OUT FOR TESTING PURPOSES
        ...
        **************************************************************/
        ...
        let emailVerificationSteps = [loginStep, passcodeStep, healthDataStep, completionStep] //***COMMENTED OUT FOR TESTING PURPOSES loginVerificationStep,
                ...
                CKStudyUser.shared.sendLoginLink(email: email) { (success) in
                    ...
                    guard success else {
                        ...
                        DispatchQueue.main.async {
                            ...
                            //stepViewController.goBackward() //***COMMENTED OUT FOR TESTING PURPOSES
                        }
                        return
                    }
