...
extension StudyTableViewController {
    ...
    */
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .showQRCode:
            taskViewController = ORKTaskViewController(task: StudyTasks.qrCodeTask, taskRun: NSUUID() as UUID)
            taskViewController.outputDirectory = CKGetTaskOutputDirectory(taskViewController)
            
        case .syncMedicalProfile:
             taskViewController = ORKTaskViewController(task: StudyTasks.medicalProfileTask, taskRun: NSUUID() as UUID)
             taskViewController.outputDirectory = CKGetTaskOutputDirectory(taskViewController)
        }
